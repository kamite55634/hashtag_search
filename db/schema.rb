...
ActiveRecord::Schema.define(version: 2019_12_23_024220) do
  ...
  create_table "hashtags_submissions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
